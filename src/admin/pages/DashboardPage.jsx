...
const ROLE_PERMISSIONS = {
  ...
  ADMIN: [
    ...
    { label: 'Jobs', path: '/osi-console/jobs', icon: Briefcase, color: 'var(--admin-amber)' },
    { label: 'Applications', path: '/osi-console/applications', icon: ClipboardList, color: 'var(--admin-purple)' },
  ],
  ENGINEER: [
    { label: 'Projects', path: '/osi-console/projects', icon: HardHat,          color: 'var(--admin-blue)' },
    { label: 'Feedback', path: '/osi-console/feedback', icon: MessageSquareText, color: 'var(--admin-green)' },
