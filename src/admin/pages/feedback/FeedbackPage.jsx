        ...
        >
          ...
          >
            ...
            <div className="admin-modal__body" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {/* Description */}
              <div>
                <p style={{ fontSize: 11, fontWeight: 700, color: 'var(--admin-gray)', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 8 }}>
                ...
                <div style={{
                  ...
                  {selected.description || <span style={{ color: 'var(--admin-gray)', fontStyle: 'italic' }}>No description provided.</span>}
                </div>
              </div>
